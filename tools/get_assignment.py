from scrapers.assignments import fetch_assignment_text
...
def get_assignment(assignment_url: str) -> str:
    ...
    Args:
        assignment_url (str): The direct URL to the assignment page
            (e.g., https://moodle.example.edu/mod/assign/view.php?id=...)

    Returns:
        str: The extracted text from all supported attachment files, preserving
    ...
    return fetch_assignment_text(url)
